  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Martins, your online food restaurant web page. Explore our menu, choose your favorites, and enjoy a seamless buying experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1504674900247-0877df9cc836?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmb29kfGVufDB8fHx8MTY5NTQ3OTQ1NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Martins, your online food restaurant web page. Explore our menu, choose your favorites, and enjoy a seamless buying experience.`}
            </Text>
            <Box
